...
import eu.renderEngine.shaders.TerrainShader;
import eu.renderEngine.terrains.Terrain;
import eu.skybox.SkyboxRenderer;
...
public class MasterRenderer {
    ...
    private void createProjectionMatrix(){
        ...
        float frumstum_length=FAR_PLANE-NEAR_PLANE;

        projectionMatrix=new Matrix4f();
        projectionMatrix.m00=x_scale;
        projectionMatrix.m11=y_scale;
        projectionMatrix.m22= -((FAR_PLANE+NEAR_PLANE)/frumstum_length);
        projectionMatrix.m23= -1;
        projectionMatrix.m32= -((2*NEAR_PLANE*FAR_PLANE)/ frumstum_length);
        projectionMatrix.m33= 0;
    }

    public static synchronized void setFogColor(float r, float g, float b){
        RED = r;
        BLUE = b;
        GREEN = g;
    }
